...
public abstract class Animal {
    ...
    public Animal(String name, Gender gender, Species species, Enum<?> color, int approxAge,
                  Size size, boolean isVaccinated, String healthStatus) {
        this.name = name;
        this.gender = gender;
    ...
    public void displayInfo() {
        System.out.println("Animal Info: " + name);
    }
}